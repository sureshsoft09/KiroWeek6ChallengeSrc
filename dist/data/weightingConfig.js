...
exports.WEIGHTING_CONFIG = void 0;
exports.getDimensionWeights = getDimensionWeights;
exports.WEIGHTING_CONFIG = {
    constraints: {
        costSensitivity: {
            low: {
                'Data Freshness': 0.15,
 ...
 */
function getDimensionWeights(costSensitivity, accuracyRequirement, dataChangeFrequency) {
    ...
    if (costSensitivity === 'high') {
        return exports.WEIGHTING_CONFIG.constraints.costSensitivity.high;
    }
    if (accuracyRequirement === 'critical') {
        return exports.WEIGHTING_CONFIG.constraints.accuracyRequirement.critical;
    }
    if (accuracyRequirement === 'high') {
        return exports.WEIGHTING_CONFIG.constraints.accuracyRequirement.high;
    }
    if (dataChangeFrequency === 'high') {
        return exports.WEIGHTING_CONFIG.constraints.dataChangeFrequency.high;
    }
    if (costSensitivity === 'medium') {
        return exports.WEIGHTING_CONFIG.constraints.costSensitivity.medium;
    }
    if (accuracyRequirement === 'medium') {
        return exports.WEIGHTING_CONFIG.constraints.accuracyRequirement.medium;
    }
    if (dataChangeFrequency === 'medium') {
        return exports.WEIGHTING_CONFIG.constraints.dataChangeFrequency.medium;
    }
    // Default to balanced weights (using low cost sensitivity as baseline)
    return exports.WEIGHTING_CONFIG.constraints.costSensitivity.low;
}
//# sourceMappingURL=weightingConfig.js.map